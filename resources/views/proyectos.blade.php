...
<x-app-layout>
    ...
    <div class="main-content">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="shell">
                <div class="navbar">
                    <div class="nav-tab active" id="navCompletar">COMPLETAR</div>
                        ...
                        <div class="proy-form-card" id="proyFormCard">
                            ...
                            <div class="ev-trigger-wrap">
                                <button type="button" class="ev-trigger-btn" id="proyBtnEvidencias">
                                    <div class="ev-trigger-left"><div class="ev-trigger-icon-box"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg></div><div class="ev-trigger-texts"><strong>Agregar Evidencias</strong><span>Imágenes, enlaces y repositorios del proyecto</span></div></div>
