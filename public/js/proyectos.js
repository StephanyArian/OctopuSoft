...
(function() {
    ...
    async function abrirPreview(id) {
        ...
        previewPage.innerHTML = `<div class="preview-doc">
            ...
            <hr class="preview-divider"><div class="preview-section-title">Descripción</div><div class="ql-snow" style="border:none;"><div class="ql-editor preview-doc-desc">${p.descripcion || ''}</div></div>
